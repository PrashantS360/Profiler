...
export function CipherMap() {
  return (
    <div className="ciphermap-container">
      <h4 className="cipher-map-text">CIPHER MAP</h4>
      <svg className="react-calendar-heatmap" viewBox="0 0 623 90">
        <g
          transform="translate(30, 0)"
          className="react-calendar-heatmap-month-labels"
        >
          <text x="11" y="10" className="react-calendar-heatmap-month-label">
            Apr
          </text>
          <text x="55" y="10" className="react-calendar-heatmap-month-label">
            May
          </text>
          <text x="110" y="10" className="react-calendar-heatmap-month-label">
            Jun
          </text>
          <text x="154" y="10" className="react-calendar-heatmap-month-label">
            Jul
          </text>
          <text x="209" y="10" className="react-calendar-heatmap-month-label">
            Aug
          </text>
          <text x="253" y="10" className="react-calendar-heatmap-month-label">
            Sep
          </text>
          <text x="297" y="10" className="react-calendar-heatmap-month-label">
            Oct
          </text>
          <text x="352" y="10" className="react-calendar-heatmap-month-label">
            Nov
          </text>
          <text x="396" y="10" className="react-calendar-heatmap-month-label">
            Dec
          </text>
          <text x="440" y="10" className="react-calendar-heatmap-month-label">
            Jan
          </text>
          <text x="495" y="10" className="react-calendar-heatmap-month-label">
            Feb
          </text>
          <text x="539" y="10" className="react-calendar-heatmap-month-label">
            Mar
          </text>
        </g>
        <g
        ...
        >
          ...
          >
            <rect
              ...
              y="0"
              className="color-cs-0"
              data-tip="0 Cipher Points on Sunday, Apr 17, 2022"
            >
              <title></title>
            </rect>
            <rect
              ...
              y="11"
              className="color-cs-0"
              data-tip="0 Cipher Points on Monday, Apr 18, 2022"
            >
              <title></title>
            </rect>
            <rect
          ...
          >
            ...
            <rect
              ...
              aria-describedby="t58aab75b-377e-4814-ae34-2c826a5b61cb"
            >
              <title></title>
            </rect>
            <rect
        ...
        >
          <text x="0" y="21" className=" react-calendar-heatmap-weekday-label">
            Mon
          </text>
          <text x="0" y="43" className=" react-calendar-heatmap-weekday-label">
            Wed
          </text>
          <text x="0" y="65" className=" react-calendar-heatmap-weekday-label">
            Fri
          </text>
        </g>
      </svg>
